...
<div x-data="historyLogMonitor()" class="min-h-screen px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        <div class="bg-gradient-to-br from-teal-500 to-emerald-600 rounded-2xl p-5 sm:p-6 text-center hover:shadow-lg transition hover:-translate-y-1">
            ...
            <p class="text-xs sm:text-sm text-teal-50 mt-1">Collections</p>
        </div>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('historyLogMonitor', () => ({
        ...
        allRecords: [
            ...
            { date: '30/09/2025', time: '09.52', bin: 'Bin #001', status: 'Battery Low', notes: 'Solar panel efficiency below 20%' },
            { date: '30/09/2025', time: '16.47', bin: 'Bin #001', status: 'Alert', notes: 'Capacity reached 90%' },
            { date: '29/09/2025', time: '14.20', bin: 'Bin #002', status: 'Empetied', notes: 'Regular Collection' },
            { date: '29/09/2025', time: '11.15', bin: 'Bin #003', status: 'Full', notes: 'Requires immediate attention' },
            { date: '28/09/2025', time: '10.30', bin: 'Bin #002', status: 'Alert', notes: 'Capacity reached 85%' },
            ...
            { date: '26/09/2025', time: '12.45', bin: 'Bin #003', status: 'Battery Low', notes: 'Maintenance required' },
            { date: '26/09/2025', time: '09.30', bin: 'Bin #002', status: 'Empetied', notes: 'Regular Collection' },
            { date: '25/09/2025', time: '14.10', bin: 'Bin #004', status: 'Alert', notes: 'Capacity reached 88%' },
            { date: '25/09/2025', time: '11.00', bin: 'Bin #001', status: 'Empetied', notes: 'Regular Collection' },
        ],
