    ...
    <div class="w-full px-6 py-6">
        ...
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-gray-600 mt-1">Last updated:
                    <span id="current-time" class="font-mono">10:42:17</span>
                </p>
            </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="bg-green-100 text-green-700 px-4 py-1 rounded-full text-sm font-medium flex items-center space-x-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 0 018 18z"/>
                            </svg>
                            <span>Normal</span>
                        </div>
                    </div>
...
<script>
    ...
    updateClock(); // panggil pas halaman dibuka
</script>
