            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 min-w-max lg:min-w-0">
                ...
                <a href="{{ route('operator.dashboard') }}" 
                   ...
                   {{ request()->routeIs('operator.dashboard') 
                        ? 'bg-blue-100 text-blue-700'  /* Jika Aktif: Background Biru, Teks Biru */
                        : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' /* Jika Tidak: Abu-abu, Hover jadi Biru Muda */
                   }}">
                ...
                <button class="flex items-center justify-center space-x-2 text-gray-600 px-4 py-3 sm:px-6 sm:py-4 rounded-xl font-semibold hover:bg-blue-50 hover:text-blue-600 transition whitespace-nowrap">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                    </svg>
